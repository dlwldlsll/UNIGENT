...
const CurriculumPage = () => {
    ...
    const courses = [
        { title: '데이터와 코딩', tags: ['조성근 교수님', '2학점', '필수교양', '피어슨 기초'], description: '피어슨의 기초와 파이썬에 대해 공부할 수 있는 과목입니다.', link: '#' },
        ...
        { title: '정량적 사고와 컴퓨팅 사고', tags: ['추지민 교수님', '2학점', '공통교양', '피어슨 기초'], description: '피어슨의 기초에 대해 학습할 수 있는 과목입니다. 다.', link: '#' },
        { title: '발명과 특허', tags: ['정가연 교수님', '3학점', '필수교양', '특허'], description: '공학지능 분야의 특허와 관련된 내용을 학습할 수 있는 과목입니다.', link: '#' },
