...
const CurriculumPage = () => {
    ...
    const semesterCourses: { [key: string]: { title: string; tags: string[]; description: string; link: string }[] } = {
        '1학년 1학기': [
            { title: '코딩과 융복합교육', tags: ['장가연 교수님', '2학점', '심화교양'], description: '코딩과 다양한 학문을 융합하여 문제 해결 능력을 기르는 과목입니다.', link: '#' },
            { title: '컴퓨터 프로그래밍 및 실습', tags: ['심춘보 교수님', '3학점', '심화교양'], description: '프로그래밍의 기초 개념을 배우고 실습을 통해 실력을 다집니다.', link: '#' },
            { title: '발명과 특허', tags: ['추영우 교수님', '3학점', '심화교양'], description: '아이디어를 발명으로 연결하고 특허를 출원하는 과정을 학습합니다.', link: '#' },
            { title: '흙에서 배우는 삶의 지혜', tags: ['전재우 교수님', '2학점', '공통교양-인성'], description: '농업 활동을 통해 생명의 소중함과 공동체 의식을 배우는 과목입니다.', link: '#' },
            { title: '심리학의 이해', tags: ['박시온 교수님', '3학점', '공통교양-핵심'], description: '인간의 마음과 행동을 과학적으로 탐구하며 자신과 타인을 이해합니다.', link: '#' },
            { title: '커뮤니케이션 일본어', tags: ['이지인 교수님', '2학점', '공통교양-글로벌의사소통'], description: '기초적인 일본어 회화 능력을 통해 글로벌 소통 역량을 강화합니다.', link: '#' },
        ],
        '1학년 2학기': [
            ...
            { title: '독서와 표현', tags: ['주아리 교수님', '2학점', '공통교양-기초'], description: '다양한 텍스트를 읽고 자신의 생각을 논리적으로 표현하는 방법을 배웁니다.', link: '#' },
        ...
        '3학년 1학기': [
            ...
            { title: '게임 프로그래밍', tags: ['한영서 교수님', '3학점', '전공선택'], description: '게임 개발에 필요한 프로그래밍 기술과 알고리즘을 학습합니다.', link: '#' },
            { title: '컴퓨터네트워크1', tags: ['이지인 교수님', '3학점', '전공선택'], description: '컴퓨터 네트워크의 기본 개념과 TCP/IP 프로토콜 스택에 대해 학습합니다.', link: '#' },
        ],
        '3학년 2학기': [
            { title: '웹프로그래밍', tags: ['김경종 교수님', '3학점', '전공선택'], description: 'HTML, CSS, JavaScript를 기반으로 동적인 웹 페이지를 개발하는 기술을 학습합니다.', link: '#' },
            { title: '시스템프로그래밍', tags: ['조용윤 교수님', '3학점', '전공선택'], description: '운영체제와 밀접하게 상호작용하는 시스템 수준의 프로그램을 개발하는 방법을 배웁니다.', link: '#' },
            { title: 'C++프로그래밍', tags: ['박철영 교수님', '3학점', '전공선택'], description: 'C++ 언어를 활용한 객체 지향 프로그래밍 및 고급 프로그래밍 기법을 익힙니다.', link: '#' },
            { title: '네트워크프로그래밍', tags: ['이성근 교수님', '3학점', '전공선택'], description: '소켓 프로그래밍을 통해 네트워크 통신 응용 프로그램을 개발하는 방법을 학습합니다.', link: '#' },
            { title: '딥러닝 기초', tags: ['박철영 교수님', '3학점', '전공선택'], description: '인공신경망의 기본 원리를 이해하고 다양한 딥러닝 모델을 구현하는 방법을 배웁니다.', link: '#' },
            { title: '디지털 영상처리', tags: ['박상현 교수님', '3학점', '전공선택'], description: '디지털 이미지의 획득, 처리, 분석 및 인식에 대한 이론과 기술을 학습합니다.', link: '#' },
            { title: '지능형 사물인터넷', tags: ['오원근 교수님', '3학점', '전공선택'], description: 'IoT 장치와 AI 기술을 결합하여 지능적인 서비스를 제공하는 시스템을 설계하고 구현합니다.', link: '#' },
            { title: '전자회로공학', tags: ['박장우 교수님', '3학점', '전공선택'], description: '다이오드, 트랜지스터 등 전자 소자의 동작 원리를 이해하고 아날로그 회로를 설계합니다.', link: '#' },
            { title: '아날로그 통신시스템', tags: ['조경룡 교수님', '3학점', '전공선택'], description: 'AM, FM 등 아날로그 변복조 방식의 원리를 이해하고 통신 시스템을 분석합니다.', link: '#' },
            { title: '초고속네트워크', tags: ['김현준 교수님', '3학점', '전공선택'], description: '광통신, ATM 등 고속 데이터 전송을 위한 네트워크 기술과 프로토콜에 대해 학습합니다.', link: '#' },
        ],
    };
